...
public class English extends AppCompatActivity {
    ...
    private void updateQuestion() {
        ...
        if (total > 10){
            ...
            databaseReference = FirebaseDatabase.getInstance().getReference().child("English").child(String.valueOf(total));
                            ...
                            if (b1.getText().toString().equals("A . "+questions.getAnswer())){
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        total = total+1;
                                        correct = correct+1;
                                        b1.setBackgroundColor(Color.parseColor("#FFB700"));
                                        updateQuestion();
                                    }
                                },1500);
                            }else {
                                ...
                                handler.postDelayed(new Runnable() {
                                    ...
                                    public void run() {
                                        b1.setBackgroundColor(Color.parseColor("#FFB700"));
                                        b2.setBackgroundColor(Color.parseColor("#FFB700"));
                                        b3.setBackgroundColor(Color.parseColor("#FFB700"));
                                        b4.setBackgroundColor(Color.parseColor("#FFB700"));
                                        updateQuestion();
                                    }
                                },1500);
